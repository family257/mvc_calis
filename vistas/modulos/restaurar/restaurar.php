...
if (isset($_POST['pk']) && isset($_POST['tabla'])) {
    ...
    // Llamar al método para restaurar el registro desde el modelo, pasando la tabla y pk
    $respuesta = Modelo::restaurarRegistroModelo($pk, $tabla);
    ...
    if ($respuesta == 'ok') {
        ...
        <script>
            ...
            Swal.fire({
                ...
                icon: 'error',
                title: 'Oops...',
                text: 'Ocurrió un error al intentar activado el registro'
            });
        </script>
        <?php
    }
